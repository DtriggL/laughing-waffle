    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                AlertDialog.Builder alert = new AlertDialog.Builder(Explore.this);

                LinearLayout layout = new LinearLayout(Explore.this);
                layout.setOrientation(LinearLayout.VERTICAL);

                final EditText titleBox = new EditText(Explore.this);
                titleBox.setHint("Crumb Title");
                layout.addView(titleBox);

                final EditText contentBox = new EditText(Explore.this);
